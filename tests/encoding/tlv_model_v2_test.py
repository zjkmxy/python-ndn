...
class TestUintField:
    ...
    def test_optional_annotation(self):
        @dataclass
        class M:
            x: int | None = field(default=None, metadata={'tlv_type': 0x03})
...
class TestBoolField:
    ...
    def test_optional_annotation(self):
        @dataclass
        class M:
            flag: bool | None = field(default=None, metadata={'tlv_type': 0x12})
...
class _DataValue:
    ...
    name:             NDNName = field(default=None, metadata={'tlv_type': 0x07})
    content:          bytes | None = field(default=None, metadata={'tlv_type': 0x15})
    signature_info:   _SigInfo | None = field(default=None, metadata={'tlv_type': 0x16})
    signature_value:  bytes | None = field(default=None, metadata={
        'tlv_type': 0x17,
...
class _InterestValue:
    ...
    nonce:               int | None = field(default=None, metadata={
                             'tlv_type': 0x0a, 'fixed_len': 4})
    _sig_cover_start:    None = field(default=None, metadata={'field_type': 'offset_marker'})
    application_parameters: bytes | None = field(default=None, metadata={'tlv_type': 0x24})
    signature_info:      _SigInfo | None = field(default=None, metadata={'tlv_type': 0x2c})
    signature_value:     bytes | None = field(default=None, metadata={
                             'tlv_type': 0x2e,
                             'field_type': 'sig_value',
                             'cover_start': '_sig_cover_start',
